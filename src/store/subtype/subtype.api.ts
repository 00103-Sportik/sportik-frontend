...
export const subtypeApi = apiSlice.injectEndpoints({
    endpoints: (builder) => ({
        ...
        postSubtypes: builder.query<void, SubtypeRequest>({
            query: (body) => ({
                url: SUBTYPES_URL,
                method: 'POST',
                body
        ...
        updateSubtypes: builder.query<void, SubtypeRequest>({
            query: (body) => ({
                url: SUBTYPES_URL,
                method: 'PUT',
                body
        ...
        deleteSubtypes: builder.query<void, Pick<SubtypeRequest, 'id'>>({
            query: (id) => ({
